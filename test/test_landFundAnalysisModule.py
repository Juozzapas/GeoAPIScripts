...
from landFundEvaluationAndAnalysis.landFundModule import BaseResult, ResultDIRV_DR10LT, ResultAZ_DR10LT, \
    LandFundAnalysis
...
class TestResultDIRV_DB10LT(unittest.TestCase):
    def setUp(self):
        self.isntance = ResultDIRV_DR10LT()
